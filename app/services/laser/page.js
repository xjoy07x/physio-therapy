    ...
    <div style={{ backgroundColor: "#ffff" }}>
      <Container className="py-5" style={{ paddingTop: "120px" }}>
        ...
        >
          ...
          <p
            style={{
              ...
              >
                A 2017 systematic review and meta-analysis found that LLLT is an effective treatment 
                modality to reduce pain in adult patients with musculoskeletal disorders. 
                They also noted that adherence to the World Association of Laser Therapy (WALT) dosages improved effectiveness.
              </p>
          ...
          >
            A 2017 review titled "Effective treatment options for musculoskeletal pain in primary care: 
            A systematic overview of current evidence" concluded that the evidence on effectiveness of 
            laser therapy for shoulder pain or acute or chronic neck pain was inconclusive. 
            With regards to knee pain low level laser therapy may confer added benefits to exercise and / or surgical treatment. 
          </p>
        </Card>
        ...
        >
          ...
          >
            <a
              href="https://www.physio-pedia.com/Low_Level_Laser_Therapy"
              target="_blank"
